-- Step 8: Safely drop and recreate the PostGIS function with correct structure
-- Drop the existing function first
DROP FUNCTION IF EXISTS get_facilities_within_radius_with_categories(DOUBLE PRECISION, DOUBLE PRECISION, DOUBLE PRECISION, TEXT);

-- Create the function with the correct structure that matches the original
