-- Final working function that handles all data type issues
-- This version properly handles NULL values and enum types
...
RETURNS TABLE (
    ...
    owner_id UUID,
    category_id UUID,  -- This can be NULL
    rating NUMERIC,
...
BEGIN
    ...
    SELECT 
        ...
        f.updated_at,
        f.owner_id,
        f.category_id,       -- Allow NULL values
        f.rating,
        f.review_count
    FROM facility_facilities f
    WHERE 
        f.status::TEXT = 'active'  -- Cast enum for comparison
