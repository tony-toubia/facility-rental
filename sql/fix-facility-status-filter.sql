-- Fix facility status filter to include both 'active' and 'approved' statuses
-- This addresses the issue where facilities with 'approved' status were not being returned
