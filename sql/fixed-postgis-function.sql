-- Fixed PostGIS function with correct data types
-- Updated to match the actual database column types
...
RETURNS TABLE (
    ...
    owner_id UUID,
    category_id UUID,
    rating NUMERIC,    -- Changed from NUMERIC to NUMERIC (already correct)
...
-- Test the function with Kansas City coordinates (where your data is located)
SELECT 
    name, 
    city, 
    state, 
