...
-- 6. Force refresh the schema cache by updating table comment (fixed syntax)
COMMENT ON TABLE public.facility_reviews IS 'Admin review data for facilities - cache refresh';

-- 7. Additional cache refresh methods
ANALYZE public.facility_reviews;

-- 8. Refresh RLS policies
