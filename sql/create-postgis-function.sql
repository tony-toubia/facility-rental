-- Create PostGIS function for radius-based facility search
-- This function returns facilities within a specified radius of a given location
...
FROM get_facilities_within_radius(40.7128, -74.0060, 100000) 
LIMIT 5;